...
public class Textures {
    ...
    public static final GuiTexture UNKNOWN_ESSENCE = new GuiTexture("textures/item/unknown_essences.png", 16, 16);
    ...
    public static final GuiTexture SCROLL_ARR_EQ_SHINE = new GuiTexture("textures/gui/scroll_arr_eq_shine.png",128,128);
    public static final GuiTexture SCROLL_ARR_SG_BASE = new GuiTexture("textures/gui/scroll_arr_sg_base.png",128,128);
    public static final GuiTexture SCROLL_ARR_SG_LIGHT = new GuiTexture("textures/gui/scroll_arr_sg_light.png",128,128);
    public static final GuiTexture SCROLL_ARR_SG_SHINE = new GuiTexture("textures/gui/scroll_arr_sg_shine.png",128,128);
