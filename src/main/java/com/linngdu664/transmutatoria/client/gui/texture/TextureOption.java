...
public record TextureOption(RenderPipeline renderPipeline, int color) {
    public static final TextureOption DEFAULT = new TextureOption(RenderPipelines.GUI_TEXTURED, -1);
    public static final TextureOption PREMULTIPLIED_ALPHA = new TextureOption(RenderPipelines.GUI_TEXTURED_PREMULTIPLIED_ALPHA, -1);
