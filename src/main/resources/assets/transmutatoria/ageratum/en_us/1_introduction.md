...
The first step of alchemy is obtaining a **Transmutation Crystal** - the starting material of the entire mod. Use it to craft a Transmutation Crucible, then use an Eye of Ender to decompose the crystal into **essence metals**, and you will step into the world of Ars Transmutatoria.
...
3. Drop the **Transmutation Crystal** into the crucible.
4. The reaction starts automatically and completes quickly. **Right-click** the crucible to take out the essence metal.

Each reaction consumes a small amount of water. It is recommended to prepare many Transmutation Crystals and decompose them in batches to accumulate a variety of essence metals.

## Essence Metals

There are **12** essence metals in total, belonging to the four elemental pillars, three for each pillar:
