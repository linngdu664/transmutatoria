...
炼金的第一步是获取**嬗变结晶**——整个模组的起点材料。用它制作混沌炼金锅，再用末影之眼将结晶分解为**源质金属**，你便踏入了混沌炼金术的世界。
...
3. 将**嬗变结晶**丢入锅中。
4. 反应自动开始，快速完成。**右键**锅取出源质金属。

每次反应消耗少量水。建议多准备嬗变结晶，批量分解以积累多样化的源质金属。
...
其中**无相源金**极为稀有（炼金分解获取概率仅 1%）。

源质金属之间的相生相克关系，以及它们的状态变化，将在下一章详细介绍。
