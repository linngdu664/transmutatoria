...
上一章你获得了第一批源质金属。本章深入理解它们之间的关系——相生相克是炼金术的核心逻辑，贯穿后续所有反应。
...
**合成与变体**：储物盒有四种变体——常态、黑化、白化、黄化——分别只收纳对应状态的源质金属。每个储物盒提供 12 个槽位，每种金属一个。

**自动收纳**：捡起源质金属时，物品栏中匹配状态的储物盒会自动吸入。

**手持使用**：手持储物盒右键打开，可以查看和整理存储的源质。配合炼金锅快速投料的方法见[进阶炼金·上：HUD 总览](4_advanced_alchemy_1.md#hud-总览)。

::: tip 提示
储物盒放在地上是方块形态，右键打开，Shift + 右键收回。
:::
